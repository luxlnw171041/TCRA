...
cimage=ReadString(formdata,Divider,14)
pixfile1=ReadFileName(formdata,Divider,15)
id_member=ReadString(formdata,Divider,16)
			...
			if pixfile1 <> "" then
					...
					if pixfile1<>"" and cimage<>0 then
						if rs("image")<>"" then
						 ...
						 ext = SaveToFile(formdata,divider,15,"../image/upload/member/"&image)
						 rs("image")=image&ext
						 rs.update
					end if 
			end if
...
<table width="auto" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <td width="612" align="left" valign="top"><table width="90%" border="0" align="center" cellpadding="5" cellspacing="0">
        ...
        <tr>
          <td align="center"><br>
            การแก้ไขข้อมูลเสร็จสมบูรณ์แล้ว </td>
        </tr>
      </table></td>
  </tr>
</table>
