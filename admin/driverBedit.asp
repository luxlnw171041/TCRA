...
<table width="auto" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <td width="612" align="left" valign="top"><table width="90%" border="0" align="center" cellpadding="5" cellspacing="0">
        <tr>
          <td class="big">แก้ไขข้อมูลพนักงานขับรถที่มีประวัติ</td>
        </tr>
        <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
                      <tr align="left" valign="top"> 
                        <td width="10" align="center" valign="middle"><input type="checkbox" name="demerit" value="เกี่ยวกับรถยนต์" <%=checked1("เกี่ยวกับรถยนต์",demerit)%>></td>
                        <td>เกี่ยวกับรถยนต์ 
