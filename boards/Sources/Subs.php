...
function theme_copyright($get_it = false)
{
	...
	static $found = false;
	$footer_txt_tcra = "<b> ¡“§¡√∂‡™Ë“‰∑¬</b> 2585/8 (µ√ß¢È“¡µ≈“¥§≈Õß‡µ¬) ∂.æ√–√“¡∑’Ë 4 ·¢«ß§≈Õß‡µ¬ ‡¢µ§≈Õß‡µ¬ °√ÿß‡∑æœ 10110 <Br />
‚∑√. 02-204-1454, 02-258-7777 µËÕ 247 ‚∑√ “√ 02-2041455, 02-258-7777 °¥ 666";
	$footer_txt_tcra .= "<br>&copy; 2002-2007 By: TCRA.or.th Allright Reserve. <a href=\"http://www.tcra.or.th\">http://www.tcra.or.th</a>&nbsp;&nbsp; E-mail : <a href=\"mailto:manager@tcra.or.th\">manager@tcra.or.th</a><script type=\"text/javascript\" src=\"../flashfix.js\"></script>";
	return $footer_txt_tcra;
...
function getLegacyAttachmentFilename($filename, $attachment_id, $new = false)
{
	...
	// Remove special accented characters - ie. sÌ.
	$clean_name = strtr($filename, 'äéöûü¿¡¬√ƒ≈«»… ÀÃÕŒœ—“”‘’÷ÿŸ⁄€‹›‡·‚„‰ÂÁËÈÍÎÏÌÓÔÒÚÛÙıˆ¯˘˙˚¸˝ˇ', 'SZszYAAAAAACEEEEIIIINOOOOOOUUUUYaaaaaaceeeeiiiinoooooouuuuyy');
	$clean_name = strtr($clean_name, array('ﬁ' => 'TH', '˛' => 'th', '–' => 'DH', '' => 'dh', 'ﬂ' => 'ss', 'å' => 'OE', 'ú' => 'oe', '∆' => 'AE', 'Ê' => 'ae', 'µ' => 'u'));
