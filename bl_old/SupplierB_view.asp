...
<table border="0" cellspacing="0" cellpadding="0" align="center" width="750">
  ...
  <tr align="left" valign="top"> 
    ...
    <td width="549"><span class="big"><strong><a href="loginnow.asp">สมาชิก</a> 
      &gt; ดูข้อมูล Supplier ที่มีประวัติ</strong></span></td>
  </tr>
  <tr align="left" valign="top"> 
    <td align="center" valign="middle"><br><br>
<table width="92%" border="1" cellpadding="5" cellspacing="0" bordercolor="#FF9933">
        <tr align="center" valign="middle" bgcolor="#FBB18E"> 
          <td width="25%"><strong>ชื่อบริษัท Supplier <br>
          Company</strong></td>
          <td width="20%"><strong>ชื่อเจ้าของบริษัท Supplier <br>
          Name </strong></td>
          <td width="35%"><STRONG>ลักษณะการกระทำความ<BR>
          Demerit</STRONG></td>
          <td width="20%"><strong>วันที่บันทึก<br>
          Date Submit</strong></td>
        </tr>
        <%
				Set rs=Server.CreateObject("ADODB.Recordset")
				sql="select ID_Supplier,Company,Name,Demerit,StartDate,ID_Member from Supplier order by StartDate DESC"
				rs.open sql,cn,1,3
						if not(rs.eof) then
        ...
        <tr align="left" valign="top"> 
          ...
          <td><a href="SupplierB_detail.asp?id_Supplier=<%=rs("id_Supplier")%>"><%=rs("Demerit")%></a></td>
          <%
