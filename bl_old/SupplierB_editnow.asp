...
id_customer=ReadString(formdata,Divider,22)
...
rs.open sql,cn,1,3
	if not(rs.eof) then
			...
			rs("demerit")=demerit
			if demeritdetail<>"" and not(isnull(demeritdetail)) and instr(demerit,"อื่นๆ")>0 then rs("demeritdetail")=demeritdetail else rs("demeritdetail")=null end if
...
<table border="0" cellspacing="0" cellpadding="0" align="center" width="750">
  ...
  <tr align="left" valign="top"> 
    ...
    <td width="580"><span class="big"><strong><a href="loginnow.asp">สมาชิก</a> 
      &gt; แก้ไขข้อมูล Supplier ที่มีประวัติ</strong></span><br>
      <br>
      <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td align="center"><br>
            การแก้ไขข้อมูล Supplier ที่มีประวัติสร็จสมบูรณ์แล้ว <br>
            <br>
