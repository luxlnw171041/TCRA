...
<table width="95%" border="1" cellpadding="5" cellspacing="0" bordercolor="#FF9933">
        <tr align="center" valign="middle" bgcolor="#FBB18E"> 
          <td><strong>ชื่อบริษัท Supplier <br>
          Company</strong></td>
          <td><strong>ชื่อเจ้าของบริษัท Supplier <br>
          Name </strong></td>
        ...
        <tr align="left" valign="top"> 
          ...
          <%
				...
				rs1.open cn.Execute(sql1)
						if not(rs1.eof) then
			%>
          <td align="center"><a href="SupplierB_detail.asp?id_Supplier=<%=rs("id_Supplier")%>"><%=rs1("Company")%></a>&nbsp;</td>
			<%
						end if
				rs1.Close
				Set rs1=nothing
