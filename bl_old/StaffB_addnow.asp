...
<table border="0" cellspacing="0" cellpadding="0" align="center" width="750">
  ...
  <tr align="left" valign="top"> 
    ...
    <td width="580"><span class="big"><strong><a href="loginnow.asp">สมาชิก</a> 
      &gt; </strong></span><span class="big"><strong>เพิ่มข้อมูลพนักงานที่มีประวัติ</strong></span><br>
      <br>
      <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td align="center"><br>
            การเพิ่มข้อมูลพนักงานที่มีประวัติสร็จสมบูรณ์แล้ว <br>
            <br>
            กลับไปหน้าเพิ่มข้อมูลพนักงานที่มีประวัติ<a href="StaffB_add.asp">คลิกที่นี่</a></td>
        </tr>
      </table>
