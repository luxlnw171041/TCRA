...
ShowName=ReadString(formdata,Divider,(int(nn)+6))
...
'						end if
						 ...
						 ext = SaveToFile(formdata,divider,(int(nn)+5),"../image/upload/Staff/"&image)
						 rs("image")=image&ext
						 rs.update
					end if 
			end if
      ...
      <!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content" -->
       	  <div class="content-data">
       	    <div class="welcome">
                ...
                <span style="font-weight:bold; color:#39F; font-size:18px; line-height:35px;">การเพิ่มข้อมูลพนักงานที่มีประวัติสร็จสมบูรณ์แล้ว</span><br />
                กลับไปหน้าเพิ่มข้อมูลพนักงานที่มีประวัติ <span id="clickhere"><a href="StaffB_add.asp">คลิกที่นี่</a></span> &nbsp;</span></div>
   	          </div>
