...
<div class="bigblock">
            ...
            <div class="subject">แก้ไขข้อมูลลูกค้าที่มีประวัติ</div>
      ...
      <!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content" -->
        ...
        <table width="90%" border="1" cellpadding="5" cellspacing="0" bordercolor="#FF9933">
          <tr align="left" valign="top"> 
            <td width="208" bgcolor="#FBB18E"><strong>ชื่อบริษัท</strong></td>
            <td width="417"><input type="text" name="company" style="width:300px;" value="<%=company%>" maxlength="200">
              <span style="color:#F00;">* </span></td>
          </tr>
          <tr align="left" valign="top"> 
            <td width="208" bgcolor="#FBB18E"><strong>ชื่อ</strong></td>
            <td><input type="text" name="name" style="width:300px;" value="<%=name%>" maxlength="200">
              <span style="color:#F00;">* </span></td>
          </tr>
			<tr align="left" valign="top"> 
            <td width="208" bgcolor="#FBB18E"><strong>นามสกุล</strong></td>
            ...
            <tr align="left" valign="top">
              ...
              <td><input type="text" name="surname2" style="width:300px;" value="<%=idcard%>" maxlength="200" />
                <span style="color:#F00;">* </span></td>
            </tr>
            <tr align="left" valign="top"> 
            <td width="208" bgcolor="#FBB18E"><strong>เพศ</strong></td>
          ...
          <tr align="left" valign="top"> 
            <td width="208" bgcolor="#FBB18E"><strong>ที่อยู่</strong></td>
          ...
          <tr align="left" valign="top"> 
            <td width="208" bgcolor="#FBB18E"><strong>จังหวัด</strong></td>
            <td> <!--#include file="../include/province.asp"--> <span style="color:#F00;">* </span></td>
          </tr>
          <tr align="left" valign="top"> 
            <td width="208" bgcolor="#FBB18E"><strong>รหัสไปรษณีย์</strong></td>
            <td><input type="text" name="zipcode" style="width:300px;" value="<%=zipcode%>" maxlength="20"></td>
          </tr>
          <tr align="left" valign="top"> 
            <td width="208" bgcolor="#FBB18E"><strong>โทรศัพท์</strong></td>
            <td><input type="text" name="telephone" style="width:300px;" value="<%=telephone%>" maxlength="20">
              <span style="color:#F00;">* </span></td>
          </tr>
          <tr align="left" valign="top"> 
            <td width="208" bgcolor="#FBB18E"><strong>โทรสาร</strong></td>
            <td><input type="text" name="fax" style="width:300px;" value="<%=fax%>" maxlength="20"></td>
          </tr>
          <tr align="left" valign="top"> 
            <td width="208" bgcolor="#FBB18E"><strong>โทรศัพท์มือถือ</strong></td>
          ...
          <tr align="left" valign="top"> 
            ...
            <td><textarea name="demerit" cols="45" rows="5"><%=demerit%></textarea>
              <span style="color:#F00;">* </span></td>
          </tr>
          <tr align="left" valign="top">
          ...
          <tr align="left" valign="top"> 
            ...
            <td><%if image<>"" and not(isnull(image)) then %>
          ...
          <tr align="left" valign="top"> 
            <td bgcolor="#FBB18E"><strong>ผู้บันทึก
