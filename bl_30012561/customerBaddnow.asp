...
Bname=ReadString(formdata,Divider,2)
...
%>
                ...
                <span style="font-weight:bold; color:#39F; font-size:18px; line-height:35px;">การเพิ่มข้อมูลลูกค้าที่มีประวัติเสร็จสมบูรณ์แล้ว</span><span style="font-size: 18px; color: #39F"><br />
                </span>กลับไปหน้าเพิ่มข้อมูลลูกค้าที่มีประวัติ <span id="clickhere"><a href="customerBadd.asp">คลิกที่นี่</a></span> &nbsp;</span></div>
   	          </div>
       	      <p>&nbsp;</p>
       	      <p>&nbsp;</p>
       	      <p>&nbsp;</p>
