...
<div class="bigblock">
            ...
            <div class="subject">แก้ไขข้อมูลพนักงานขับรถที่มีประวัติ</div>
	...
	<div class="bigblock">
      ...
      <!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content" -->
       	  <div class="content-data">
       	    <form name="form" action="driverBeditnow.asp" enctype="multipart/form-data" method="post" onSubmit="return chkAction()">
        <table width="90%" border="1" cellpadding="5" cellspacing="0" bordercolor="#FF9933">
          <tr align="left" valign="top"> 
            <td width="206" bgcolor="#FBB18E"><strong>ชื่อ</strong></td>
            <td width="419"><input type="text" name="name" style="width:300px;" value="<%=name%>" maxlength="200">
              <span style="color:#F00;"> * </span></td>
          </tr>
          <tr align="left" valign="top"> 
            <td width="206" bgcolor="#FBB18E"><strong>นามสกุล</strong></td>
          ...
          <tr align="left" valign="top"> 
            <td width="206" bgcolor="#FBB18E"><strong>เพศ</strong></td>
          ...
          <tr align="left" valign="top"> 
            <td width="206" bgcolor="#FBB18E"><strong>ที่อยู่</strong></td>
...
<strong><span style="color:#F00;">* เลือกอย่างน้อย 1 ช่อง</span></strong>
<table width="100%" border="0" cellspacing="0" cellpadding="2">
  <tr align="left" valign="top">
    <td width="20" align="center" valign="middle"><input type="checkbox" name="demerit" value="เกี่ยวกับรถยนต์" /></td>
    <td width="163">เกี่ยวกับรถยนต์ </td>
    <td width="20"><input type="checkbox" name="demerit" value="กฏข้อบังคับบริษัท" /></td>
    <td width="200">เกี่ยวกับกฏข้อบังคับบริษัท</td>
  </tr>
  <tr align="left" valign="top">
    <td width="20" align="center" valign="middle"><input type="checkbox" name="demerit" value="เกี่ยวกับลูกค้า" /></td>
    <td>เกี่ยวกับลูกค้า</td>
    <td><input type="checkbox" name="demerit" value="เกี่ยวกับผิดกฏหมาย" /></td>
    <td>เกี่ยวกับผิดกฎหมาย</td>
  </tr>
  <tr align="left" valign="top">
    <td width="20" align="center" valign="middle"><input type="checkbox" name="demerit" value="อื่นๆ" /></td>
    <td>อื่นๆ</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
...
<TEXTAREA NAME="demeritdetail" ROWS="5" COLS="45"><%=demeritdetail%></TEXTAREA></td></tr>
          ...
          <tr align="left" valign="top"> 
            ...
            <td> 
              ...
              มีรูปภาพแล้ว รูปปัจจุบันคือ <a href="../image/upload/driver/<%=image%>" target="_new"><%=image%></a> 
              <%else%>
              <input type="radio" name="cImage" value="0" checked>
              ไม่มีรูปภาพ 
              <%end if%>
          ...
          <tr align="left" valign="top"> 
            <td bgcolor="#FBB18E"><strong>ข้อมูลผู้บันทึก
            ...
            <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
                <tr align="left" valign="top"> 
                  <td width="133"><strong>รหัสสมาชิก</strong></td>
                  <td width="279"><%=iID%></td>
                </tr>
                <tr align="left" valign="top"> 
                  <td width="133"><strong>ชื่อผู้ใช้ระบบ</strong></td>
                  <td><%=iUsername%></td>
                </tr>
                <tr align="left" valign="top"> 
                  <td width="133"><strong>ชื่อบริษัท</strong></td>
                  <td><%=iCompany%></td>
                </tr>
                <tr align="left" valign="top"> 
