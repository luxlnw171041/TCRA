...
pixfile1=ReadFileName(formdata,Divider,19)
ShowName=ReadString(formdata,Divider,20)
...
'						end if
						 ...
						 ext = SaveToFile(formdata,divider,(int(nn)+5),"../image/upload/Supplier/"&image)
						 rs("image")=image&ext
						 rs.update
					end if 
			end if
      ...
      <!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content" -->
       	  <div class="content-data">
       	    <div class="welcome">
                ...
                <span style="font-weight:bold; color:#39F; font-size:18px; line-height:35px;">การเพิ่มข้อมูล&nbsp;Supplier&nbsp;ที่มีประวัติสร็จสมบูรณ์แล้ว </span><br />
                กลับไปหน้าเพิ่มข้อมูล Supplier ที่มีประวัติ <span id="clickhere"><a href="SupplierB_Add.asp">คลิกที่นี่</a></span></span></div>
   	          </div>
       	      <p>&nbsp;</p>
       	      <p>&nbsp;</p>
       	      <p>&nbsp;</p>
