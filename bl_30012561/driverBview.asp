	...
	<div class="bigblock">
        ...
        <div class="menu"> <img src="../bl/images/mainmenu.jpg" width="239" height="55" />
          <div id="navside">
            ...
            <div class="sec-bmenu">
              ...
              <ul>
                <li class="current"><a href="driverBview.asp">ดูข้อมูลพนักงานขับรถที่มีประวัติ</a></li>
              </ul>
            </div>
            <div class="sec-ymenu">
              <ul>
      ...
      <!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content" -->
        ...
        <tr align="center" valign="middle" bgcolor="#FBB18E"> 
          ...
          <td><strong>เลขที่บัตรประชาขน</strong></td>
          <td><strong>วันที่บันทึก</strong></td>
        </tr>
        <%
				Set rs=Server.CreateObject("ADODB.Recordset")
				sql="select ID_Driver,Name,Surname,IDCard,StartDate,ID_Member from Driver order by StartDate DESC"
				rs.open sql,cn,1,3
						if not(rs.eof) then
