...
<div class="bigblock">
            ...
            <div class="subject">ดูข้อมูลลูกค้าที่มีประวัติ</div>
        ...
        <div class="menu"> <img src="../bl/images/mainmenu.jpg" width="239" height="55" />
          <div id="navside">
            <div class="sec-ymenu">
              ...
              <ul>
                <li class="current"><a href="customerBview.asp">ดูข้อมูลลูกค้าที่มีประวัติ</a></li>
              </ul>
            </div>
            <div class="sec-bmenu">
              <ul>
       	  ...
       	  <div class="content-data">
       	    <table width="90%" border="1" cellpadding="5" cellspacing="0" bordercolor="#FF9933">
       	      <tr align="left" valign="top">
       	        <td width="190" bgcolor="#FBB18E"><strong>ชื่อบริษัท</strong></td>
       	        <td width="462"><%=company%></td>
   	          </tr>
       	      <tr align="left" valign="top">
       	        <td width="190" bgcolor="#FBB18E"><strong>ชื่อ - นามสกุล</strong></td>
       	        <td><%=name%> - <%=surname%></td>
   	          </tr>
       	      <tr align="left" valign="top">
       	      ...
       	      <tr align="left" valign="top">
       	        <td width="190" bgcolor="#FBB18E"><strong>เพศ</strong></td>
       	        <td><%=sex%></td>
   	          </tr>
       	      <tr align="left" valign="top">
       	        <td width="190" bgcolor="#FBB18E"><strong>ที่อยู่</strong></td>
       	      ...
       	      <tr align="left" valign="top">
       	        <td width="190" bgcolor="#FBB18E"><strong>จังหวัด</strong></td>
       	        <td><%=province%></td>
   	          </tr>
       	      <tr align="left" valign="top">
       	        <td width="190" bgcolor="#FBB18E"><strong>รหัสไปรษณีย์</strong></td>
       	        <td><%=zipcode%></td>
   	          </tr>
       	      <tr align="left" valign="top">
       	        <td width="190" bgcolor="#FBB18E"><strong>โทรศัพท์</strong></td>
       	        <td><%=telephone%> &nbsp;</td>
   	          </tr>
       	      <tr align="left" valign="top">
       	        <td width="190" bgcolor="#FBB18E"><strong>โทรสาร</strong></td>
       	        <td><%=fax%> &nbsp;</td>
   	          </tr>
       	      <tr align="left" valign="top">
       	        <td width="190" bgcolor="#FBB18E"><strong>โทรศัพท์มือถือ</strong></td>
       	        <td><%=mobile%> &nbsp;</td>
   	          </tr>
       	      <tr align="left" valign="top">
			  ...
			  <tr align="left" valign="top">
       	      ...
       	      <tr align="left" valign="top">
       	        ...
       	        <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
       	          <tr>
       	            <td width="75%"><%= FormatDateTime(startdate, 1)%></td>
   	              </tr>
     	          </table></td>
   	          </tr>
   	        </table>
