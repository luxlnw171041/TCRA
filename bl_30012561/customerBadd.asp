      ...
      <div class="contain"><!-- InstanceBeginEditable name="menu" -->
        <div class="menu"> <img src="../bl/images/mainmenu.jpg" width="239" height="55" />
          <div id="navside">
            <div class="sec-ymenu">
              <ul>
                <li class="current"><a href="customerBadd.asp">เพิ่มข้อมูลลูกค้าที่มีประวัติ</a></li>
              </ul>
              <ul>
      ...
      <!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content" -->
        ...
        <table width="90%" border="1" cellpadding="5" cellspacing="0" bordercolor="#FF9933">
          <tr align="left" valign="top"> 
            <td width="206" bgcolor="#FBB18E"><strong>ชื่อบริษัท</strong></td>
            <td width="419"><input type="text" name="company" style="width:300px;" value="" maxlength="200"><span style="color:#F00;"> * </span></td>
          </tr>
          <tr align="left" valign="top"> 
            <td width="206" bgcolor="#FBB18E"><strong>ชื่อ</strong></td>
            <td><input type="text" name="name" style="width:300px;" value="" maxlength="200"><span style="color:#F00;"> * </span></td>
          </tr>
		            <tr align="left" valign="top"> 
            <td width="206" bgcolor="#FBB18E"><strong>นามสกุล</strong></td>
            <td><input type="text" name="surname" style="width:300px;" value="" maxlength="200"><span style="color:#F00;"> * </span></td>
          </tr>
              <tr align="left" valign="top">
                      <td bgcolor="#FBB18E"><strong>เลขที่บัตรประชาขน</strong></td>
            ...
            <td>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr align="left" valign="middle">
                  ...
                  <td width="85%"><input type="text" name="address" style="width:250px;" maxlength="100"><span style="color:#F00;"> * </span></td>
                </tr>
                <tr align="left" valign="middle">
                  <td>ซอย</td>
                ...
                <tr align="left" valign="middle">
                  <td>เขต</td>
                  <td><input type="text" name="address" style="width:250px;" maxlength="100"><span style="color:#F00;"> * </span></td>
                </tr>
              </table> </td>
          </tr>
          <tr align="left" valign="top"> 
          ...
          <tr align="left" valign="top"> 
            ...
            <td><input type="text" name="telephone" style="width:300px;" value="" maxlength="20">
              <span style="color:#F00;">* </span></td>
          </tr>
          <tr align="left" valign="top"> 
            <td width="206" bgcolor="#FBB18E"><strong>โทรสาร</strong></td>
          ...
          <tr align="left" valign="top"> 
            ...
            <td><textarea name="demerit" cols="45" rows="5"></textarea> <span style="color:#F00;"> * </span>
			  </td>
          </tr>
          <tr align="left" valign="top">
          ...
          <tr align="left" valign="top"> 
            <td bgcolor="#FBB18E"><strong>ผู้บันทึก<span style="color:#F00;"> * </span><br />
            </strong>
            ...
            <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
                ...
                <tr align="left" valign="top"> 
                  <td width="141"><strong>รหัสสมาชิก</strong></td>
                  <td width="305"><%=iID%></td>
                </tr>
                <tr align="left" valign="top"> 
                  <td width="141"><strong>ชื่อผู้ใช้ระบบ</strong></td>
                  <td><%=iUsername%></td>
                </tr>
                <tr align="left" valign="top"> 
                  <td width="141"><strong>ชื่อบริษัท</strong></td>
                  <td><%=iCompany%></td>
                </tr>
                <tr align="left" valign="top"> 
...
/*				if(!a.fax.value) {
				...
				if(!a.mobile.value) {
						...
						if(!a.demerit.value) {
							alert("กรุณาระบุ ลักษณะการกระทำความผิด");
							return false;
						}
