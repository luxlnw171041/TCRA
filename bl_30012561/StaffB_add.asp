...
<div class="bigblock">
            ...
            <div class="subject">เพิ่มข้อมูลพนักงานที่มีประวัติ</div>
      ...
      <div class="contain"><!-- InstanceBeginEditable name="menu" -->
        <div class="menu"> <img src="../bl/images/mainmenu.jpg" width="239" height="55" />
          <div id="navside">
            ...
            <div class="sec-bmenu">
              <ul>
                <li class="current"><a href="StaffB_add.asp">เพิ่มข้อมูลพนักงานที่มีประวัติ</a></li>
              </ul>
              <ul>
      ...
      <!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content" -->
        ...
        <table width="90%" border="1" cellpadding="5" cellspacing="0" bordercolor="#FF9933">
          <tr align="left" valign="top"> 
            ...
            <td width="418"><input type="text" name="name" style="width:300px;" value="" maxlength="200">
...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
                <tr align="left" valign="top">
                  ...
                  <td colspan="3"><strong><span style="color:#F00;">* เลือกอย่างน้อย 1 ช่อง</span></strong></td>
                  </tr>
                <tr align="left" valign="top"> 
                  <td width="20" align="center" valign="middle"><input type="checkbox" name="demerit" value="เกี่ยวกับรถยนต์"></td>
                  <td width="162">เกี่ยวกับรถยนต์ </td>
...
<TEXTAREA NAME="demeritdetail" ROWS="5" COLS="45"></TEXTAREA></td></tr>
