...
require_once('../connect/function.php');
					   ...
					   //=========== บันทึกข้อมูล
						$sql_up = "insert into drivers(d_name, d_surname, d_idno, d_sex, d_dispr, d_pic, d_date) Values ('$_POST[name]','$_POST[surname]','$_POST[idcard]','$_POST[sex]','" . $d_dispr . "','" . $file_name . "','" . $d_date . "')";
...
<!--            <div class="sec-ymenu">
      ...
      <!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content" -->
       	  <div class="content-data">
       	    <form name="form" method="post" action="<?=$_SERVER['PHP_SELF'];?>?ID=<?=$_GET["id"];?>&Action=Save" enctype="multipart/form-data" onSubmit="return chkAction()">
