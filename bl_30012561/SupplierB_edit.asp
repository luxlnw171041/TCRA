      ...
      <!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content" -->
        ...
        <table width="90%" border="1" cellpadding="5" cellspacing="0" bordercolor="#FF9933">
          <tr align="left" valign="top"> 
            ...
            <td width="418"><input type="text" name="company" style="width:300px;" value="<%=company%>" maxlength="200">
          ...
          <tr align="left" valign="top"> 
            ...
            <td> <input type="radio" name="sex" value="M" <%=checked("M",sex)%> >
              ชาย 
              <input type="radio" name="sex" value="F" <%=checked("F",sex)%>>
              หญิง 
              <input type="radio" name="sex" value="C" <%=checked("C",sex)%> />
              บริษัท</td>
          </tr>
          <tr align="left" valign="top"> 
...
<span style="color:#F00;">* </span></td>
          ...
          <tr align="left" valign="top"> 
            ...
            <td> 
              ...
              มีรูปภาพแล้ว รูปปัจจุบันคือ <a href="../image/upload/Supplier/<%=image%>" target="_new"><%=image%></a> 
              <%else%>
              <input type="radio" name="cImage" value="0" checked>
              ไม่มีรูปภาพ 
              <%end if%>
        ...
        <div align="center"><br>
	  <input type="hidden" name="id_Supplier" value="<%=request("id_Supplier")%>">
