...
If ShowName = "ShowName" then id_Staff=ReadString(formdata,Divider,(int(nn)+8)) else  id_Staff=ReadString(formdata,Divider,(int(nn)+7)) end if
      ...
      <!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content" -->
       	  <div class="content-data">
       	    <div class="welcome">
                ...
                <span style="font-weight:bold; color:#39F; font-size:18px; line-height:35px;">การแก้ไขข้อมูลพนักงานที่มีประวัติเสร็จสมบูรณ์แล้ว</span><br />
