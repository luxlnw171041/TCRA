...
<div class="bigblock">
            ...
            <!-- TemplateBeginEditable name="subject" -->
  ...
  <div class="block-c">
	<div class="bigblock">
      <div class="contain"><!-- TemplateBeginEditable name="menu" -->
      ...
      <!-- TemplateEndEditable --><!-- TemplateBeginEditable name="content" -->
       	  <div class="content-data">
       	    <div class="welcome">
       	      ...
       	      <div style="background-image:url(../bl/images/bg-name.jpg); width:429px; height:77px;">
