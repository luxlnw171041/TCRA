...
<div class="con-head">
    ...
    <div class="boxbody" style="background-image:url(images/boxbody.gif); background-repeat:no-repeat;">
  	  <div class="index-contain">
      		<div class="article">
      		  <a href="updatenewsf99-112.php" target="_blank"><span style="font-weight:bolder; font-size:14px;"><font color="#ed4e05">สมาคมรถเช่าไทยจัดประชุม ครั้งที่ 4/2565 ผ่านระบบ Video Conference Zoom Meetings ตามมาตรการป้องกันไวรัส Covid-19</font></span></a>
      		  
 <br/>&nbsp;&nbsp;&nbsp;เมื่อวันพุธที่ 23 พฤศจิกายน 2565  ที่ผ่านมา ดร.นที  วรรธนะโกวินท์  นายกสมาคมฯ  คุณวสันต์ ติรยาอุดมสุข อุปนายกสมาคมฯ  จัดประชุม ผ่านระบบ Video Conference Zoom Meetings ร่วมกับสมาชิกสมาคมฯ... 
 <br/><br/>&nbsp;&nbsp;&nbsp;
<a href="updatenewsf99-112.php" target="_new">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<< อ่านต่อ >></a></div>
  <div class="pic-slide" style="padding-top:8px; font-size:20px; font-weight:bolder;">
        ข่าวสารสมาคม<img src="flash/slide-news99-112.gif" width="416" height="251" /></div>      
  	    <br style="clear:both;" />
  	  </div>
    </div>  
    ...
    <tr>
      ...
      <tr>
        <td bgcolor="#FFFFFF"><div class="events-news">
          ...
          <div class="subevent">
            <div style="padding-left:22px; color:#FFF; font-size:12px; width:150px;"><span style="font-size: 16px">26 สิงหาคม 2565</span></div>
            <div class="pic"><img src="images/news/picnews99a-110.jpg" alt="" width="69" height="57" /></div>
            <div class="textevent">
              <a href="updatenewsf99-110.php" target="_blank" style="color:#006fd7;"><span style="color: #6eb337">สมาคมรถเช่าไทย ได้รับรางวัล<br/>สมาคมการค้าดีเด่น <br/>ประจำปี 2565
</span></a>
            </div>
            <br style="clear:both;" />
            <div style="padding-left:200px;"><a href="updatenewsf99-110.php" target="_blank"><img src="images/readmore.png" alt="" width="42" height="12" border="0" /></a></div>
          </div>
...
<iframe width="210" height="600" src="https://www.bangchak.co.th/th/oilprice/widget" frameborder="0" scrolling="no"></iframe>
</div></div>
