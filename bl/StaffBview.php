  ...
  <div class="block-c">
	...
	<!--    <div class="sec-bmenu">
            ...
            <div class="sec-bmenu">
              ...
              <ul>
                <li class="current"><a href="StaffBview.php">ค้นหาข้อมูลพนักงานที่มีประวัติ</a></li>
              </ul>
            </div>
      ...
      <!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content" -->
       	...
       	<form name="form2" action="StaffBresult.php" method="post" onSubmit="return chkAction()"><br>
        ...
        <table width="90%" border="1" cellpadding="5" cellspacing="0" bordercolor="#FF9933">
          ...
          <tr align="left" valign="top"> 
            ...
            <td>เลขบัตรประชาชน : <input type="text" name="txtidno" id="txtidno" style="width:100px;" maxlength="30">&nbsp;&nbsp; <br /></td>
          </tr>
          <tr align="left" valign="top">
