  ...
  <div class="block-c">
	...
	<!--    <div class="sec-bmenu">
     		...
     		<div class="sec-bmenu">
              ...
              <ul>
                <li class="current"><a href="SupplierBview.php">ค้นหาข้อมูล Supplier ที่มีประวัติ</a></li>
              </ul>
            </div>
            <div class="sec-ymenu">
              <ul>
      ...
      <!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content" -->
       	...
       	<form name="form2" action="SupplierBresult.php" method="post" onSubmit="return chkAction()"><br>
        ...
        <table width="90%" border="1" cellpadding="5" cellspacing="0" bordercolor="#FF9933">
          ...
          <tr align="left" valign="top"> 
            ...
            <td>เลขประจำตัวผู้เสียภาษี : <input type="text" name="txtidno" id="txtidno" style="width:100px;" maxlength="30">&nbsp;&nbsp; <br /></td>
          </tr>
          <tr align="left" valign="top">
            <td bgcolor="#FBB18E">&nbsp;</td>
            <td>ชื่อ :
              <input type="text" name="txts_name" id="txts_name" style="width:100px;" maxlength="30" />
              &nbsp;&nbsp;
            นามสกุล :
            <input type="text" name="txts_sname" id="txts_sname" style="width:100px;" maxlength="30" />
            &nbsp;&nbsp;
