...
<div class="bigblock">
            ...
            <div class="subject">ค้นหาข้อมูล</div>
  ...
  <div class="block-c">
	...
	<!--    <div class="sec-bmenu">
      ...
      <!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content" -->
       	...
       	<form name="form2" action="custresult.php" method="post" onSubmit="return chkAction()"><br>
        ...
        <table width="90%" border="1" cellpadding="5" cellspacing="0" bordercolor="#FF9933">
          ...
          <tr align="left" valign="top"> 
            <td width="130" bgcolor="#FBB18E"><strong>คำที่ต้องการค้นหา (Keyword)</strong></td>
            <td>เลขบัตรประชาชน / เลขประจำตัวผู้เสียภาษี : <input type="text" name="txtidno" id="txtidno" style="width:100px;" maxlength="30">&nbsp;&nbsp; <br /></td>
          </tr>
          <tr align="left" valign="top">
            <td bgcolor="#FBB18E">&nbsp;</td>
            <td>ชื่อ :
              <input type="text" name="txtc_name" id="txtc_name" style="width:100px;" maxlength="30" />
              &nbsp;&nbsp;
            นามสกุล :
            <input type="text" name="txtc_sname" id="txtc_sname" style="width:100px;" maxlength="30" />
            &nbsp;&nbsp;
