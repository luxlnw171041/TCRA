	  ...
	  <!--  <div class="sec-bmenu">
			...
			?>
             ...
             <div class="sec-ymenu">
              ...
              <ul>
                <li><a href="custBlist.php">แสดงข้อมูลลูกค้าทั้งหมด</a></li>
              </ul>
              <ul>
                <li><a href="SupplierBlist.php">แสดงข้อมูลคู่ค้า Supplier ทั้งหมด</a></li>
              </ul>
              <ul>
                <li><a href="StaffBlist.php">แสดงข้อมูลพนักงานทั้งหมด</a></li>
              </ul>
              <ul>
                <li><a href="chauffeurBlist.php">แสดงข้อมูลพนักงานขับรถทั้งหมด</a></li>
              </ul>
      ...
      <!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content" -->
       	  <div class="content-data">
       	    <div class="welcome">
       	      ...
       	      <p>คุณสามารถเพิ่มข้อมูลลูกค้า คู่ค้า พนักงาน และค้นหาข้อมูลที่มีประวัติได้</p>
