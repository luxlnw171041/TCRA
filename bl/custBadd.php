...
require_once('../connect/function.php');
					   ...
					   //=========== ตรวจสอบว่ารหัสนี้มีอยู่หรือยัง
						$resultChk=select("customer","where 1=1 and c_idno='".$_POST["idcard"]."'");
						if($resultChk)
						{
...
//							echo "".$fileUpload."<br>";
					   ...
					   //=========== บันทึกข้อมูล  date("d/m/y H:m:s")
						$sql_up = "insert into customer(rentname, compname, c_name, c_surname, c_idno, demerit, demeritdetail, c_pic, c_date, member_user, member_co, member_keyin) Values ('$_POST[rentname]','$_POST[compname]','$_POST[name]','$_POST[surname]','$_POST[idcard]','$_POST[demerit]','$_POST[demeritdetail]','" . $file_name . "','" . $c_date . "','$_SESSION[user]','$_SESSION[member_co]','".date("d/m/y H:m:s")."')";
  ...
  <div class="block-c">
	<div class="bigblock">
      <div class="contain"><!-- InstanceBeginEditable name="menu" -->
       ...
       <div class="sec-bmenu">
              <ul>
                <li class="current"><a href="custBadd.php">เพิ่มข้อมูลลูกค้าที่มีประวัติ</a></li>
              </ul>
              <ul>
      ...
      <!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content" -->
        ...
        <table width="98%" border="1" cellpadding="5" cellspacing="0" bordercolor="#FF9933">
          <tr align="left" valign="top"> 
            <td width="207" bgcolor="#FBB18E"><strong>ติดต่อในนาม</strong></td>
            <td width="476"><input type="radio" name="rentname" value="บุคคล" checked>
              บุคคล 
              <input type="radio" name="rentname" value="บริษัท">
              บริษัท <span style="color:#F00;">* </span>  <input type="text" name="compname" style="width:300px;" value="" maxlength="200">
          ...
          <tr align="left" valign="top"> 
            <td bgcolor="#FBB18E"><strong>เลขบัตรประชาชน/เลขประจำตัวผู้เสียภาษี</strong></td>
