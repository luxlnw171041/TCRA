...
<!--            <div class="sec-ymenu">
 ...
 <!--           <div class="sec-ymenu">
      ...
      <!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content" -->
       	...
       	<form name="form2" action="result.php" method="post" onSubmit="return chkAction()"><br>
        ...
        <table width="90%" border="1" cellpadding="5" cellspacing="0" bordercolor="#FF9933">
          ...
          <tr align="left" valign="top">
            ...
            <td>ชื่อ :
              <input type="text" name="txtd_name" id="txtd_name" style="width:100px;" maxlength="30" />
              &nbsp;&nbsp;
            นามสกุล :
            <input type="text" name="txtd_sname" id="txtd_sname" style="width:100px;" maxlength="30" />
            &nbsp;&nbsp;
