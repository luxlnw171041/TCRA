      ...
      <table width="90%" border="1" cellpadding="5" cellspacing="0" bordercolor="#FF9933">
        <tr align="center" valign="middle" bgcolor="#FBB18E"> 
         ...
         <tr align="left" valign="top">    
          ...
          <td align="center"><?=$result["member_id"];?></td>
          <td align="left"><?=$result["member_user"];?></td>
          <td align="left"><?=$result["member_pass"];?></td>
          <td align="left"><?=$result["member_co"];?></td>
          <td align="left"><?=$result["member_addr"];?></td>
          <td align="left"><?=$result["member_tel"];?></td>
          <td align="center"><div align="center">
		   <?
			  if($result["member_status"]=="Yes")
			  {
			  echo "<img src=\"./images/true.png\" width=\"12\" height=\"12\" title=\"เปิดใช้งาน\">";
			  }
			  else
			  {
			   echo "<img src=\"./images/false.png\" width=\"12\" height=\"12\" title=\"ปิดชั่วคราว\">";
			  }
			  ?>
          </div>
          </td>
          <td><div align="center"><a href="editmember.php?ID=<?=$result["id"];?>"><img src="./images/edit_icon.gif" width="15" height="15" border="0"></a></div></td>
         </tr>
