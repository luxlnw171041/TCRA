...
//===========  อ่านข้อมูล
	...
	$stridno="";	
	if($_POST["txtidno"]){
		$stridno=" c_idno='".$_POST["txtidno"]."'";
	  }else {
			$stridno="";
			}
	$strname="";	
	if($_POST["txtc_name"]){
		$strname=" c_name='".$_POST["txtc_name"]."'";
	  }else {
			$strname="";
			}
	...
	$strsname="";		
	if($_POST["txtc_sname"]){
		$strsname=" c_surname='".$_POST["txtc_sname"]."' ";
	  }else {
			$strsname="";
		    }
	...
	if($stridno=="" && $strname=="" && $strsname=="") {
		...
		echo"window.location='StaffBview.php';";
		echo"</script>";	
	}else {
	...
	if($stridno=="" and $strname!=="" and $strsname!=="") {
		$strsql = "select * from customer where $strname AND $strsname";
	}
	if($stridno!=="" and $strname=="" and $strsname=="") {
		$strsql = "select * from customer where $stridno ";
	}
	if($stridno!=="" and $strname=="" and $strsname!=="") {
		$strsql = "select * from customer where $stridno AND $strsname";
	}
	if($stridno!=="" and $strname!=="" and $strsname=="") {
		$strsql = "select * from customer where $stridno AND $strname";
	}
	if($stridno!=="" and $strname!=="" and $strsname!==""){
		$strsql = "SELECT * FROM customer WHERE $stridno AND $strname AND $strsname";
	}
	...
	//{
      ...
      <table width="90%" border="1" cellpadding="5" cellspacing="0" bordercolor="#FF9933">
        <tr align="center" valign="middle" bgcolor="#FBB18E"> 
          <td><strong>เช่ารถในนาม</strong></td>
          <td><strong>ชื่อ-นามสกุล</strong></td>
          <td><strong>เลขบัตรประชาชน / <br /> เลขประจำตัวผู้เสียภาษี</strong></td>
        ...
        <tr align="left" valign="top"> 
          ...
          <td><?=$result["rentname"];?>&nbsp;&nbsp;&nbsp;<?=$result["compname"];?></td>
